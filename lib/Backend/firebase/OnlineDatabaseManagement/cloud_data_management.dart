...
import 'package:google_signin/Global_Uses/send_notification_management.dart';
...
class CloudStoreDataManagement {
  ...
  Future<bool> checkThisUserAlreadyPresentOrNot(
    ...
    try {
      ...
      log('Error in Checkj This User Already Present or not: ${e.toString()}');
      return false;
    }
  }
  ...
  Future<bool> registerNewUser(
    ...
    try {
      ...
      log('Error in Register new user: ${e.toString()}');
      return false;
    }
  }
  ...
  Future<bool> userRecordPresentOrNot({required String email}) async {
    try {
      ...
      log('Error in user Record Present or not: ${e.toString()}');
      return false;
    }
  }
  ...
  Future<Map<String, dynamic>> getTokenFromCloudStore(
    ...
    try {
      final DocumentSnapshot<Map<String, dynamic>> documentSnapshot =
          await FirebaseFirestore.instance
              .doc('$_collectionName/$userMail')
              .get();

      log('DocumentSnapShot is: ${documentSnapshot.data()}');
      ...
      log('Error in get Token from Cloud Store: ${e.toString()}');
      return {};
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getAllUsersListExceptMyAccount(
    ...
    try {
      ...
      log('Error in get All Users List: ${e.toString()}');
      return [];
    }
  }
  ...
  Future<Map<String, dynamic>?> _getCurrentAccountAllData(
    ...
    try {
      ...
      log('Error in getCurrentAccountAll Data: ${e.toString()}');
      return {};
    }
  }
  ...
  Future<List<dynamic>> currentUserConnectionRequestList(
    ...
    try {
      ...
      log('Collection: $_connectionRequestCollection');

      return _connectionRequestCollection;
    } catch (e) {
      log('Error in Current USer Collection List: ${e.toString()}');
      return [];
    }
  }
  ...
  Future<void> changeConnectionStatus({
    ...
    try {
      ...
      for (var element in _oppositeConnectionsRequestsList) {
      ...
      log('Opposite Connections: $_oppositeConnectionsRequestsList');
      ...
      log('Error in Change Connection Status: ${e.toString()}');
    }
  }
  ...
  Future<Stream<QuerySnapshot<Map<String, dynamic>>>?>
    ...
    try {
      ...
      log('Error in Fetch Real Time Data : ${e.toString()}');
      return null;
    }
  }
  ...
  Future<void> sendMessageToConnection(
    ...
    try {
      ...
      log("Data checking: ${connectedUserData[FirestoreFieldConstants().connections]}");
      ...
      log('error in Send Data: ${e.toString()}');
    }
  }
  ...
  Future<void> removeOldMessages({required String connectionEmail}) async {
    try {
      ...
      log("After Remove: ${connectedUserData[FirestoreFieldConstants().connections]}");
  ...
  Future<String?> uploadMediaToStorage(File filePath,
    ...
    try {
      ...
      log('Firebase Storage Reference: $firebaseStorageRef');
      ...
      log("Error: Firebase Storage Exception is: ${e.toString()}");
      return null;
    }
  }
}
