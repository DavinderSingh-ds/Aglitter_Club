...
class LocalDatabase {
  ...
  Future<void> createTableToStoreImportantData() async {
    try {
      ...
      log('User Important table creatred');
    } catch (e) {
      log('Error in Create Import Table: ${e.toString()}');
    }
  }
  ...
  Future<bool> insertOrUpdateDataForThisAccount({
    ...
    try {
      ...
      if (purpose != 'insert') {
        ...
        log('Update Result is: $updateResult');
      } else {
      ...
      log('Error in Insert or Update Important Data Table');
      return false;
    }
  }
  ...
  Future<String?> getParticularFieldDataFromImportantTable(
    ...
    try {
      ...
      log('Error in getParticularFieldDataFromImportantTable: ${e.toString()}');
    }
    return null;
  }
  ...
  Future<bool> createTableForUserActivity({required String tableName}) async {
    ...
    try {
      ...
      log('User Activity table creatred');

      return true;
    } catch (e) {
      log("Error in Create Table For Status: ${e.toString()}");
      return false;
    }
  }
  ...
  Future<bool> insertDataInUserActivityTable(
    ...
    try {
      final Database db = await database;
      final Map<String, dynamic> _activityStoreMap = <String, dynamic>{};
      ...
      log('Error: Activity Table Data insertion Error: ${e.toString()}');
      return false;
    }
  }
  ...
  Future<void> createTableForEveryUser({required String userName}) async {
    try {
      ...
      log("Error in Create Table For Every User: ${e.toString()}");
    }
  }
  ...
  Future<void> insertMessageInUserTable(
    ...
    try {
      ...
      log('Row Affected: $rowAffected');
    } catch (e) {
      log('Error in Insert Message In User Table: ${e.toString()}');
    }
  }
